...
/**
 * Created by thib146 on 30/03/2017.
 */

public class AddProjectDialog extends DialogFragment {

    @BindView(R.id.dialog_project) EditText dialogProject;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") View custom = inflater.inflate(R.layout.add_project_dialog, null);

        ButterKnife.bind(this, custom);

        dialogProject.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                mProject = dialogProject.getText().toString();
        ...
        builder.setMessage(getString(R.string.project_dialog_title));
        builder.setPositiveButton(getString(R.string.project_dialog_add),
        ...
        builder.setNegativeButton(getString(R.string.project_dialog_cancel), null);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Activity) {
            mActivity = (Activity) context; // Store the main activity in mActivity for the Add Project function to work properly
        }
    }

    // Add a stock to the main Stock List activity
    private void addProject() {
        ((MainActivity) mActivity).addProject(dialogProject.getText().toString());
