...
public final class Contract {
    ...
    public static final class ProjectEntry implements BaseColumns {
        ...
        public static final int POSITION_PROJECT_ID = 1;
        public static final int POSITION_PROJECT_NAME = 2;
        public static final int POSITION_PROJECT_DATE = 3;
        public static final int POSITION_PROJECT_COLOR = 4;

        public static final String[] COLUMNS =
                {_ID, COLUMN_PROJECT_ID, COLUMN_PROJECT_NAME, COLUMN_PROJECT_DATE, COLUMN_PROJECT_COLOR};
    ...
    public static final class TaskEntry implements BaseColumns {
        ...
        public static final int POSITION_ID = 0;
        public static final int POSITION_TASK_ID = 1;
        public static final int POSITION_TASK_PROJECT_ID = 2;
        public static final int POSITION_TASK_NAME = 3;
        public static final int POSITION_TASK_DATE = 4;
        public static final int POSITION_TASK_STATUS = 5;
        public static final int POSITION_TASK_PRIORITY = 6;
        public static final int POSITION_TASK_REMINDER_DATE = 7;

        public static final String[] COLUMNS =
                {_ID, COLUMN_TASK_ID, COLUMN_TASK_PROJECT_ID, COLUMN_TASK_NAME, COLUMN_TASK_DATE,
